...
- [ ] 월간 캘린더 뷰에 토마토 수확 표시
- [ ] 날짜 클릭 시 상세 정보 Bottom Sheet
- [ ] 농장별 필터링 드롭다운

**💾 커밋**: `📅 feat: 캘린더 기반 통계 시스템 완성`
